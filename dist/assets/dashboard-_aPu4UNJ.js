...
<div class="stat-grid" style="margin-top:16px">
  ...
  <div class="stat-card"><div class="label">${t(`swap_horiz`)} 映射版本</div><div class="value" title="${n(d.index_metadata?.mapping_version||``)}">${d.index_metadata?.mapping_version?String(d.index_metadata.mapping_version).substring(0,8)+`...`:`-`}</div></div>
