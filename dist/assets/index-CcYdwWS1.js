const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./dashboard-C-VbbeJI.js","./core-D4_C68Ut.js"])))=>i.map(i=>d[i]);
import{A as e,C as t,D as n,I as r,L as i,M as a,O as o,R as s,_ as c,a as l,c as u,g as d,i as f,l as p,n as m,o as h,r as g,s as _,u as v,w as y,z as b}from"./core-D4_C68Ut.js";(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var x={webdav_host:`OpenList 的 WebDAV 服务地址。
格式：http://IP:端口/dav
