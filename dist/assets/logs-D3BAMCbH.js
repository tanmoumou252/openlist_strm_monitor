...
</table>`,document.getElementById(`logs-refresh`).addEventListener(`click`,()=>{r(()=>import(`./core-BOG7mpy_.js`).then(e=>e.f).then(e=>e.router()),[],import.meta.url)})}export{a as renderLogs};