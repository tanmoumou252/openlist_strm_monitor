...
</table>`,document.getElementById(`logs-refresh`).addEventListener(`click`,()=>{r(()=>import(`./core-BRoB2fU5.js`).then(e=>e.f).then(e=>e.router()),[],import.meta.url)})}export{a as renderLogs};