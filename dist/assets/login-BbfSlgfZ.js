import{I as e,d as t,m as n}from"./core-99DnM501.js";async function r(r){let i=!1,a=!1;try{i=(await n(`/api/admin/status`)).has_password,a=!0}catch{}let o=localStorage.getItem(`session_token`);if(o&&i){t(`#dashboard`);return}if(o&&!i&&a&&localStorage.removeItem(`session_token`),!i){r.innerHTML=`
