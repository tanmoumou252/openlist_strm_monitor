import{L as e,c as t,o as n}from"./core-BIAj9xz_.js";async function r(r){let i=!1,a=!1;try{i=(await t(`/api/admin/status`)).has_password,a=!0}catch{}let o=localStorage.getItem(`session_token`);if(o&&i){n(`#dashboard`);return}if(o&&!i&&a&&localStorage.removeItem(`session_token`),!i){r.innerHTML=`
